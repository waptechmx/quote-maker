...
TOPIC = "fitness"         # Available topics: christian, fitness
SHOW_AUTHOR = False         # Shows the author of the quote under the quote (if available)
CUSTOMER_NAME = "your_name"
NUM_OF_POSTS = 15           # Disable limit: -1 (will create images according to the amount of quotes in the .txt file)
...
quote_font = f"{project_dir}/sources/fonts/BebasNeueBold-7B9LE.ttf"       # Bible
# quote_font = f"{project_dir}/sources/fonts/Bebas-KM7y.ttf"       # Fitness
author_font = f"{project_dir}/sources/fonts/BebasNeueRegular-X34j2.otf"
